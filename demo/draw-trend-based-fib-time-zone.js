...
// let line1 = new cc.Line({x: 10, y: 10}, {x: 100, y: 100})
// window['line1'] = line1
// layer.appendChildren(line1)
// let tween = new cc.StaticTween()
// tween.target = line1
// tween.set('p0', {x: 200, y: 10})
// let wait = new cc.EmptyTween()
// wait.wait(1000)
// wait.target = line1

// let tran = new cc.Transition(line1)
let line
...
function startDrawLine(e) {
	...
	line = new cc.TrendBasedFibonacciTimeZone({x1: x, y1: y, x2: x, y2: y, x3: x, y3: y})
	line.isDrawing = true
